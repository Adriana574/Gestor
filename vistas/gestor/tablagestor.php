		...
		<div class="table-responsive">
			<table class="table table-hover" id="tablaGestorDataTable">
				<thead style="text-align: center; background-color: #0293A4; color: white">
					<tr>
						<th style="font-family: Lucida Bright">CATEGORIA</th>
						<th style="font-family: Lucida Bright">NOMBRE</th>
						<th style="font-family: Lucida Bright">EXTENSION DE ARCHIVO</th>
						<th style="font-family: Lucida Bright">DESCARGAR</th>
						<th style="font-family: Lucida Bright">VISUALIZAR</th>
